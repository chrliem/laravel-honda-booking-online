        ...
        <td class="body" width="100%" cellpadding="0" cellspacing="0" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; background-color: #ffffff; border-bottom: 1px solid #edeff2; border-top: 1px solid #edeff2; margin: 0; padding: 0; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
            ...
            <tr>
                <td class="content-cell" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; padding: 35px;">
                    ...
                    <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Yth. Bapak/Ibu {{$data['nama_customer']}}, terima kasih telah melakukan booking online di {{$data['nama_dealer']}}. Tim kami akan segera mengkonfirmasi atas ketersediaan booking tersebut. Kode booking Anda adalah {{$data['kode_booking']}}</p>
                    <h2 style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #2F3133; font-size: 16px; font-weight: bold; margin-top: 0; text-align: left;">Data Booking Anda</h2>
                        ...
                        <table style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; margin: 30px auto; width: 100%; -premailer-cellpadding: 0; -premailer-cellspacing: 0; -premailer-width: 100%;">
                            ...
                            <tr>
                                ...
                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787e; font-size: 15px; padding: 10px 0;">
                                    <img src="https://be.bintang-group.co.id/storage/no_rangka_image/{{$data['no_rangka_image']}}" width="200" height="100"/></td>
                                @else
